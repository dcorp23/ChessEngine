...
const int knightSquareEval[64] = {
    -100, -50, -40, -35, -35, -40, -50, -100, 
    -50, -50, -35, -10, -10, -35, -50, -50, 
    -40, -20, 70, 20, 20, 70, -20, -40, 
    -20, -5, 35, 45, 45, 35, -5, -20, 
    -20, -5, 35, 45, 45, 35, -5, -20, 
    -40, -20, 70, 20, 20, 70, -20, -40, 
    -50, -50, -35, -10, -10, -35, -50, -50, 
    -100, -60, -40, -35, -35, -40, -60, -100
};
...
float pieceActivity(Board* board, std::vector<int>* attackVector) {
    ...
    whiteSquares = (whiteSquares * 20) * (board->state.whiteToMove ? 1 : 1); 
    blackSquares = (blackSquares * 20) * (board->state.whiteToMove ? 1 : 1); 
