...
float Search::minimax(Board* board, int depth, bool isMaximizingPlayer, float alpha, float beta) {
...
void Search::threadMinMax(Board* board, int currentIndex, int* bestIndex, float* bestEval, int depth, float* alpha, float* beta) {
